...
class CreateAndEditRecipeFormType extends AbstractType
{
        ...
        $builder
            ->add('title', TextType::class, [
                ...
                'constraints' => [
                    ...
                    new NotBlank([
                        'message' => 'Merci de renseigner un titre', // Error if the field is empty
                    ]),
            ...
            ->add('image', FileType::class, [
                ...
                'constraints' => [
                    ...
                    new NotBlank([
                        // Error message if the form is send without file
